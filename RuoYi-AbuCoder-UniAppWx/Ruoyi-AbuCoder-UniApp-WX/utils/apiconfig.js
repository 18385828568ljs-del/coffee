...
export const wxAvatarUploadUrl = `${baseUrl}/wxapi/uploadAvatar`
...
export const orderApi = {
	...
	refundApply: `${baseUrl}/api/order/refund/apply`,
	refundInfo: `${baseUrl}/api/order/refund/`
}
...
export const cardApi = {
	active: `${baseUrl}/api/card/campaign/active`,
	draw: `${baseUrl}/api/card/draw`,
	result: `${baseUrl}/api/card/result/`,
	my: `${baseUrl}/api/card/my`
}
...
export const scanOrderApi = {
	...
	refundApply: `${baseUrl}/api/scanOrder/refund/apply`,
	refundInfo: `${baseUrl}/api/scanOrder/refund/`
}
