				...
				>
					...
					>
						...
						<view v-else class="floor-empty">
							<image class="floor-empty-image" src="/static/empty-product.svg" mode="aspectFit"></image>
...
export default {
	...
	methods: {
		...
		getProductImage(item, index = 0) {
			...
			return resolveImageUrl(getProductImages(item)[0])
		},
...
.category-shell {
	...
	border-bottom: 2rpx solid rgba(122, 79, 45, 0.12);
	box-shadow: 0 8rpx 18rpx rgba(36, 24, 19, 0.06);
}
...
.category-chip-active {
	...
	box-shadow: 0 8rpx 18rpx rgba(122, 79, 45, 0.18);
}
...
.product-card {
	...
	border-radius: 24rpx;
	background: #FFFFFF;
	border: 2rpx solid rgba(122, 79, 45, 0.1);
	box-shadow: 0 10rpx 24rpx rgba(36, 24, 19, 0.09);
	box-sizing: border-box;
	@include active-press;
}
...
.product-promo-tag {
	...
	border: 1rpx solid rgba(122, 79, 45, 0.12);
	font-family: $font-family;
	font-size: 21rpx;
	font-weight: 600;
	line-height: 1.2;
...
.stepper-add {
	background: $accent-primary;
	border-color: $accent-primary;
	box-shadow: 0 8rpx 16rpx rgba(122, 79, 45, 0.18);
}
